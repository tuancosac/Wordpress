...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } else { ?>
			<?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-white');?> 
          	<a href="<?php echo esc_url('https://www.sktthemes.org/shop/skt-white/');?>" rel="noopener" target="_blank">
            <?php esc_html_e('SKT White','skt-white'); ?>
            </a>
            <?php } ?>
        </div>
     <div class="clear"></div>
